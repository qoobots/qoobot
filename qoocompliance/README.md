...
| 模块 | 说明 | 状态 |
|------|------|------|
| `safety/` | 机器人安全标准（ISO 10218、ISO 13482、ISO/TS 15066） | ✅ 已完成 |
| `radio/` | 无线通信认证（FCC、CE RED、SRRC、MIC） | ✅ 已完成 |
| `emc/` | 电磁兼容（IEC 61000、CISPR） | ✅ 已完成 |
| `privacy/` | 隐私法规（GDPR、PIPL、CCPA、AI Act） | ✅ 已完成 |
| `liability/` | 责任与保险框架（产品责任、AI 决策责任） | ✅ 已完成 |
| `export/` | 出口管制合规（EAR、ITAR、中国出口管制法） | ✅ 已完成 |
| `functional_safety/` | 功能安全（IEC 61508、ISO 13849） | ✅ 已完成 |
| `cybersecurity/` | 网络安全（IEC 62443、NIST） | ✅ 已完成 |
| `accessibility/` | 无障碍设计标准 | ✅ 已完成 |
| `environmental/` | 环保合规（RoHS、REACH、WEEE） | ✅ 已完成 |
