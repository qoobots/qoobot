"""qoodev LSP Server implementation using pygls."""
...
logger = logging.getLogger("qoodev-lsp")


class QooLspServer:
    """qoodev Language Server for robot skill development."""

    def __init__(self):
        self.server = LanguageServer("qoodev-lsp", "0.3.0")
    ...
    def _register_handlers(self):
        ...
        def on_initialized(ls: LanguageServer, params: InitializedParams):
            logger.info("qoodev LSP server initialized")
