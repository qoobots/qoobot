"""Completion engine — provides intelligent code completion for qoodev projects."""
...
logger = logging.getLogger("qoodev-lsp.completion")
...
class QooCompletionEngine:
    ...
    def _get_type_completions(self, line_prefix: str, lines: list[str]) -> list[CompletionItem]:
        ...
        is_qoo_project = any(
            ...
            for keyword in ["qoobot_sdk", "QooSkill", "from qoodev", "import qoodev"]
        )
