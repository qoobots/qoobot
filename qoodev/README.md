...
| 模块 | 说明 | 状态 |
|------|------|------|
| `cli/` | 命令行开发工具（项目脚手架、构建、发布） | ✅ 已完成 |
| `ide_plugin/` | VSCode / JetBrains 插件 | ✅ 已完成 |
| `simulator/` | 机器人仿真调试环境（Isaac Sim / MuJoCo / Gazebo） | ✅ 已完成 |
| `debugger/` | 机器人行为调试器（断点、回放、状态检查、可视化） | ✅ 已完成 |
| `profiler/` | 性能剖析（全链路延迟、资源火焰图、通信带宽） | ✅ 已完成 |
| `data_labeler/` | 训练数据标注工具（点云、图像、轨迹） | ✅ 已完成 |
| `ci_cd/` | 自动化测试与部署流水线 | ✅ 已完成 |
| `sdk/` | Python/C++ SDK（`qoobot-sdk`） | ✅ 已完成 |
| `docs/` | 文档站点（API 参考、教程、示例） | ✅ 已完成 |
