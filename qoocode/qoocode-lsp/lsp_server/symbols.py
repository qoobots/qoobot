"""Symbol engine — document symbol outline for qoocode files."""
...
logger = logging.getLogger("qoocode-lsp.symbols")


class QooSymbolEngine:
    """Provides document symbols for qoocode project files."""
