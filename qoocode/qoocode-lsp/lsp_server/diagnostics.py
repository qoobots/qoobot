"""Diagnostics engine — validates qoocode project files."""
...
logger = logging.getLogger("qoocode-lsp.diagnostics")


class QooDiagnosticEngine:
    """Provides project-aware diagnostics for qoocode files."""
