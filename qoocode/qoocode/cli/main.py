...
from qoocode.cli.commands import package_cmd, record_cmd, debug_cmd, ci_cmd
from qoocode.stability.error_handler import (
    QooCodeError,
    global_error_handler,
    ErrorBoundary,
    ErrorSeverity,
)
from qoocode.stability.crash_collector import install_crash_hook
...
def callback(
    ...
    sys.excepthook = global_error_handler(
        ...
        report_url=os.environ.get("QOOCODE_CRASH_URL", ""),
    )
...
def eco_submit(
    ...
    from qoocode.qooeco import create_qooeco_client
...
def eco_search(
    ...
    from qoocode.qooeco import create_qooeco_client, SkillCategory
...
def docs_generate(
    ...
    from qoocode.docs_generator import DocSiteGenerator
