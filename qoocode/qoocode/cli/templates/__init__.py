...
def get_template(name: str) -> TemplateGenerator:
    ...
    """
    if name == "skill":
        from qoocode.cli.templates.skill import SkillTemplate
        return SkillTemplate()
    elif name == "service":
        from qoocode.cli.templates.service import ServiceTemplate
        return ServiceTemplate()
    elif name == "model":
        from qoocode.cli.templates.model import ModelTemplate
