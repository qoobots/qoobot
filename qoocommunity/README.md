...
| 模块 | 说明 | 状态 |
|------|------|------|
| `conference/` | QooBot 全球开发者大会（年度） | ✅ 已完成 |
| `dev_program/` | 开发者计划（注册、认证、等级、权益） | ✅ 已完成 |
| `academy/` | QooBot 学院（在线课程、认证考试、实训） | ✅ 已完成 |
| `forums/` | 开发者社区论坛（问答、展示、协作） | ✅ 已完成 |
| `evangelist/` | 技术布道（博客、视频、演讲、workshop） | ✅ 已完成 |
| `university/` | 高校合作（课程、实验室、竞赛、奖学金） | ✅ 已完成 |
| `showcase/` | 作品展示平台（案例库、demo 视频） | ✅ 已完成 |
| `hackathon/` | 黑客马拉松（线上/线下、主题赛、奖金） | ✅ 已完成 |
| `ambassador/` | 社区大使计划（地区代表、用户组） | ✅ 已完成 |
